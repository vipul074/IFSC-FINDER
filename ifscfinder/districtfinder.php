...
?>
<?php
  $sql2a="SELECT DISTINCT district FROM `TABLE 6` WHERE bank_name='$piece3' and state='$name4'";
...
<title>All <?php echo $piece3;?> branches in <?php echo $name4;?> with IFSC Code List</title>
<meta content="noodp, noydir" name="robots">
<meta content="All <?php echo $piece3;?> branches in <?php echo $name4;?> IFSC Code, Contact Phone Number, Address List." name="description">
<meta content="All <?php echo $piece3;?> branches in <?php echo $name4;?>,IFSC Code" name="keywords">
...
<div class="col-lg-12">
 ...
 <div class="col-lg-3" style="padding-top:35px;padding-right:0px">
	  <strong>What is <?php echo $piece3;?> <?php echo $name4;?> IFSC Code?</strong>
      ...
      <strong>What is  <?php echo $piece3;?> <?php echo $name4;?> MICR Code?</strong>
	  ...
	  <h3 style="color:#015198;font-size:14px;"><?php echo $piece3;?> <?php echo $name4;?> IFSC Code</h3>
	  <p style="text-align:justify"><?php echo $piece3;?> <?php echo $name4;?> has Branches. This bank has branches in the following states. States list as follows {districtlist}. Find Indian Financial System Code, Magnetic Ink Character Recognition, SWIFT Code, Address and Contact number of all Abhyudaya Co-op Bank Ltd branches.</p>
 </div>
 <div class="col-lg-6" style="padding-top:28px">
  <div class="col-lg-12 above">
  <h1 style="color:#015198;margin-bottom: 22px;font-size:22px;">All <?php echo $piece3;?> branches in <?php echo $name4;?> with IFSC Code</h1>
  ...
  <span style="color:#015198;float: left;font-size: 11px;">Select bank name > Select State > Select District</span><br>
	  <?php
		echo '<form id="form3" method="get" action="../imtermediate3.php">';
		echo '<img src="../images/3.png"><select name="bank_name"><option value="'.$name.'">'.$piece3.'</option></select><img src="../images/4.png"><br>';
		echo '<img src="../images/3.png"><select name="state"><option value="'.$state.'">'.$name4.'</option></select><img src="../images/4.png"><br>';
		$sql="SELECT DISTINCT district FROM `TABLE 6` WHERE bank_name='$piece3' and state='$name4' ORDER BY district";
		$res=mysqli_query($conn,$sql);
		echo '<img src="../images/2.png"><select name="district" id="district">';
		...
		echo '<img src="../images/2.png" style="margin-left:-28px"><select><option>Branch</option></select>';
		echo '</form>';
  ...
  <div class="col-lg-12 below">
   <h4 style="text-align:center;color:rgb(1, 81, 152);"><?php echo $piece3;?> Bank is in <?php echo $counter;?> Districts Of <?php echo $name4;?></h4>
      <h2 style="text-align:center;color:#015198;margin-bottom: 22px;font-size:15px;">District wise list of <?php echo $piece3;?> in <?php echo $name4;?></h2>
   <?php
    echo '<div id="detail">';
	$sql2="SELECT DISTINCT district FROM `TABLE 6` WHERE bank_name='$piece3' and state='$name4' ORDER BY district";
	...
	$que2=explode(" ",$que);
	$que3=implode($que2,"-");
	echo '<a href="../'.$pieces.'/'.$state.'/'.$que3.'"><img src="../images/6.png">'.$p['district'].'</a><br>';
	}
	echo '</div>';
  ?>
   </div>      
    ...
    <div class="col-lg-3" style="padding-top:35px;padding-right:0px">
		<strong>What is <?php echo $piece3;?> <?php echo $name4;?> RTGS?</strong>
	  ...
	  <strong>What is <?php echo $piece3;?> <?php echo $name4;?> NEFT?</strong>
	  ...
	  <h4 style="color:#015198;font-size:12px;"><?php echo $piece3;?> <?php echo $name4;?> Home Loans</h4>
	  <h4 style="color:#015198;font-size:12px;"><?php echo $piece3;?> <?php echo $name4;?> Personal Loans</h4>
	  <h4 style="color:#015198;font-size:12px;"><?php echo $piece3;?> <?php echo $name4;?> Car Loans</h4>
	</div>
